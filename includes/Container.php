...
class Container extends \Pimple\Container {
	 ...
	 * If you use this function outside a VEForAll entry point (such as a hook,
	...
	/**
	 * Get a specific item from the VEForAll Container.
	 * This should only be used from entry points (hooks and such) into VEForAll from mediawiki core.
	 *
	 * @param string $name
	 * @return mixed
	 */
